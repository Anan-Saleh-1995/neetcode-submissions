class Solution {
    public boolean isSubsequence(String s, String t) {
        ...
        */
        ...
        Map<Integer, Integer> memorizer = new HashMap<>();
        for (int i = 0; i < s.length(); i++) { /* 'happy' */
            char cs = s.charAt(i);
            // int j = 0;
            // chatgpt helped me on this one
            // int j = (i == 0) ? 0 : memorizer.get(s.charAt(i-1)) + 1;
            int j = (i == 0) ? 0 : memorizer.get(i - 1) + 1;
